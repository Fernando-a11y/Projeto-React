...
function Calculadora() {
  ...
  return (
    <div className="calculator">
      ...
      <button className="operator clear" data-value="clear" onClick={handleClick}>
        AC
      </button>
      <button className="operator delete" data-value="delete" onClick={handleClick}>
        &lt;
      </button>
      <button className="operator porcent" data-value="%" onClick={handleClick}>
        %
      </button>
      ...
      <button className="operator equals" data-value="=" onClick={handleClick}>
        =
      </button>
    </div>
  );
